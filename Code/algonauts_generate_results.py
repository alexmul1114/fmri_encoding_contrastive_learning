...
from algonauts_results_utils import tsne_visualization, get_violin_plot, get_results_cross_subj, get_results_single_subj_all_rois, get_people_classifier_results, image_classification_results
...
parser.add_argument("--type", help="Options are single-subj, cross-subj, violin, people-classifier, classification-task", type=str, required=True)
...
if __name__ == '__main__':
    ...
    elif (method=="people-classifier"):
        get_people_classifier_results(project_dir, device, subj_num, hemisphere, all_rois=True)
